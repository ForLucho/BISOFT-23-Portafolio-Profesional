      ...
      <footer className="footer footer-bg-darkblue text-light " id="footer">
        ...
        <div className="container row footer-container footer-custom-row">
          ...
          <div className="col-md-6">
            <h2 className="footer-title mt-5 mb-5">{t("footer.contactTitle")}</h2>
            <div className="footer-info">
              <i className="bi bi-telephone"></i>
              <div className="text-container">
                <h3 className="footer-column-title">{t("footer.callMe")}</h3>
            ...
            <div className="footer-info">
              ...
              <div className="text-container">
                <h3 className="footer-column-title">{t("footer.emailMe")}</h3>
            ...
            <div className="footer-info">
              ...
              <div className="text-container">
                <h3 className="footer-column-title">{t("footer.findMe")}</h3>
          ...
          <div className="row col-md-6 footer-custom-md-6">
            <div>
              <h2 className="footer-title mt-5 mb-5">{t("footer.hireServicesTitle")}</h2>
